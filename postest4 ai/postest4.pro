...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * *  
* dicurigai semua orang yang besenjata yang *  
...
/* * * * * * * * * * * * * * * * * * * * * * * * * *  
* dicurigai pria yang selingkuh dengan siti. *
* * * * * * * * * * * * * * * * * * * * * * * * * */ 
...
/* * * * * * * * * * * * * * * * * * * * * * *  
* dicurigai wanita yang selingkuh dengan *  
* pria yang juga selingkuh dengan siti *  
* * * * * * * * * * * * * * * * * * * * * * */ 
 	...
 	dicurigai(X):-					%X dicurigai jika maka   
  	...
  	pembunuh(Pembunuh):-  				%pembunuh tersebut dikatakan pembunuh jika maka
  		...
  		ternodai(Terbunuh,Zat). 		%yang terbunuh ternodai oleh zat
  			%Domains digunakan untuk memberikan nama pada parameter
